...
XLSX_FILE_PATH = "output/sdn_output_feature_test_nullmissingfts_workingcountry.xlsx"
...
def extract_date(element, ns):
    """Extract date from a DatePeriod element."""
    if element is not None:
        date_period = element.find(".//ns:DatePeriod", ns)
...
def get_location_value(root, location_id, ns):
    """Get the location value for a given LocationID."""
        ...
        for feature in features:
            ...
            if version_detail is not None:
                ...
                if detail_type_id == "1431":  # LOOKUP
                    ...
                    value = extract_date(version_detail, ns)
            ...
            if feature_type in [
                ...
                if version_location is not None:
                    ...
                    value = get_location_value(root, location_id, ns)
